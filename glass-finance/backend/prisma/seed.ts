...
async function main() {
    ...
    const incomeCategories = [
        ...
        { name: 'Thưởng', icon: '🎁', color: '#3b82f6', type: 'income' },
        { name: 'Freelance', icon: '💼', color: '#8b5cf6', type: 'income' },
        { name: 'Đầu tư', icon: '📈', color: '#06b6d4', type: 'income' },
        { name: 'Thu nhập khác', icon: '💵', color: '#14b8a6', type: 'income' },
    ];

    const expenseCategories = [
        { name: 'Ăn uống', icon: '🍔', color: '#ef4444', type: 'expense' },
        { name: 'Di chuyển', icon: '🚗', color: '#f59e0b', type: 'expense' },
        { name: 'Mua sắm', icon: '🛍️', color: '#ec4899', type: 'expense' },
        { name: 'Giải trí', icon: '🎮', color: '#6366f1', type: 'expense' },
        { name: 'Hóa đơn', icon: '💡', color: '#14b8a6', type: 'expense' },
        { name: 'Y tế', icon: '🏥', color: '#f43f5e', type: 'expense' },
        { name: 'Giáo dục', icon: '📚', color: '#0ea5e9', type: 'expense' },
        { name: 'Nhà cửa', icon: '🏠', color: '#84cc16', type: 'expense' },
        { name: 'Quần áo', icon: '👔', color: '#a855f7', type: 'expense' },
        { name: 'Làm đẹp', icon: '💄', color: '#d946ef', type: 'expense' },
        { name: 'Thể thao', icon: '⚽', color: '#22c55e', type: 'expense' },
        { name: 'Du lịch', icon: '✈️', color: '#06b6d4', type: 'expense' },
    ];
